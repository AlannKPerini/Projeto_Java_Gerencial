...
public class VENDA extends javax.swing.JDialog {
    ...
    // instãncia da classe de banco de dados
    Banco_Dados bd = new Banco_Dados();
    // variáveis usadas para calcular os produtos add na nota fiscal
   ...
   void limparTABELA() {
    ...
    private void initComponents() {
        ...
        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MODULO_DE_VENDAS/filezila.png"))); // NOI18N
