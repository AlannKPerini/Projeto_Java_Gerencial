 ...
 * @author Alann Kelly
 */
public class testentradatela extends javax.swing.JDialog {

    /**
     * Creates new form testentradatela
     */
    public testentradatela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testentradatela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                testentradatela dialog = new testentradatela(new javax.swing.JFrame(), true);
